...
const CreateForm = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      component: (
        <Textarea
          ...
          onChange={(e: any) =>
            handleInputChange("informationTypes", e.target.value)
          }
        />
      ),
    },
    {
      ...
      description:
        "e.g., teenagers, adults, seniors — helps with tone and complexity",
      field: "ageGroup",
      component: (
        <Textarea
    ...
    <div className="container mx-auto py-8 px-4">
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Based on your inputs, create your custom form by adding questions
            below.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-8">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>
              Get AI-powered suggestions for your form questions
            </CardDescription>
          </div>
          <Button
            ...
            <div className="text-center py-6 text-gray-500">
              {isGenerating ? (
                <div className="flex flex-col items-center">
                  ...
                  <p>
                    Generating smart suggestions based on your form
                    requirements...
                  </p>
                </div>
              ) : (
                <p>
                  Click "Generate Suggestions" to get AI-powered question ideas
                  for your form.
                </p>
              )}
            </div>
      ...
      <Card>
        ...
        <CardContent>
          {questions.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              No questions added yet. Add some questions to see your form
              preview.
            </div>
          ) : (
        ...
        {showSuccess && (
          <div className="fixed bottom-5 right-5 bg-green-500 text-white px-4 py-2 rounded shadow-md transition-all z-50">
            ✅ Form submitted successfully Onchain!
          </div>
        )}
      </Card>
    </div>

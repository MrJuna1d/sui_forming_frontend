...
const marketplaceItems = {
  weapons: [
    ...
    },
    {
      ...
      currency: "SUI",
      image:
        "https://images.unsplash.com/photo-1605979257913-1704eb7b6246?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHBpeGVsJTIwYXJ0JTIwZmlyZXxlbnwwfHwwfHx8MA%3D",
      seller: "DragonSlayer",
      stats: {
        damage: 150,
        speed: 60,
    ...
    },
    {
      ...
      currency: "SUI",
      image:
        "https://images.unsplash.com/photo-1550745165-9bc0b252726f?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHBpeGVsJTIwYXJ0JTIwd29vZHxlbnwwfHwwfHx8MA%3D",
      seller: "WizardKing",
      stats: {
        damage: 90,
        speed: 70,
  ...
  skins: [
    {
      ...
      seller: "CosmicDesigner",
      stats: {
        uniqueEffects: "Celestial trail, star particles",
    ...
    },
    {
      ...
      seller: "DragonMaster",
      stats: {
        uniqueEffects: "Fire aura, dragon scales",
        exclusivity: "Season Pass Reward",
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-950 via-purple-900 to-indigo-900 text-white p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-purple-300 mt-1">Buy, sell, and trade your in-game assets</p>
        </div>
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          <Select value={activeTab} onValueChange={setActiveTab}>
            ...
            <SelectContent className="bg-purple-900 border-purple-700 text-white">
              <SelectItem value="weapons" className="focus:bg-purple-800 focus:text-white">
                Weapons
              </SelectItem>
              <SelectItem value="armor" className="focus:bg-purple-800 focus:text-white">
                Armor
              </SelectItem>
              <SelectItem value="accessories" className="focus:bg-purple-800 focus:text-white">
                Accessories
              </SelectItem>
              <SelectItem value="skins" className="focus:bg-purple-800 focus:text-white">
                Skins
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        {showFilters && (
          <div className="bg-purple-900/50 rounded-lg p-4 mb-4 border border-purple-700 grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              <Label className="text-sm text-purple-300 mb-2 block">Rarity</Label>
              <Select value={selectedRarity} onValueChange={setSelectedRarity}>
                <SelectTrigger className="bg-purple-900/50 border-purple-700 text-white focus:ring-purple-500">
                  <SelectValue placeholder="All Rarities" />
                </SelectTrigger>
                <SelectContent className="bg-purple-900 border-purple-700 text-white">
                  <SelectItem value="all" className="focus:bg-purple-800 focus:text-white">
                    All Rarities
                  </SelectItem>
                  <SelectItem value="Common" className="focus:bg-purple-800 focus:text-white">
                    Common
                  </SelectItem>
                  <SelectItem value="Uncommon" className="focus:bg-purple-800 focus:text-white">
                    Uncommon
                  </SelectItem>
                  <SelectItem value="Rare" className="focus:bg-purple-800 focus:text-white">
                    Rare
                  </SelectItem>
                  <SelectItem value="Epic" className="focus:bg-purple-800 focus:text-white">
                    Epic
                  </SelectItem>
                  <SelectItem value="Legendary" className="focus:bg-purple-800 focus:text-white">
                    Legendary
                  </SelectItem>
                  <SelectItem value="Mythic" className="focus:bg-purple-800 focus:text-white">
                    Mythic
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            <div>
              <Label className="text-sm text-purple-300 mb-2 block">Sort By</Label>
              <Select defaultValue="price-asc">
                <SelectTrigger className="bg-purple-900/50 border-purple-700 text-white focus:ring-purple-500">
                  <SelectValue placeholder="Sort by" />
                </SelectTrigger>
                <SelectContent className="bg-purple-900 border-purple-700 text-white">
                  <SelectItem value="price-asc" className="focus:bg-purple-800 focus:text-white">
                    Price: Low to High
                  </SelectItem>
                  <SelectItem value="price-desc" className="focus:bg-purple-800 focus:text-white">
                    Price: High to Low
                  </SelectItem>
                  <SelectItem value="rarity" className="focus:bg-purple-800 focus:text-white">
                    Rarity
                  </SelectItem>
                  <SelectItem value="newest" className="focus:bg-purple-800 focus:text-white">
                    Newest
                  </SelectItem>
                </SelectContent>
              </Select>
        ...
        <div className="lg:col-span-2">
          <Tabs defaultValue={activeTab} value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="bg-purple-900/50 border border-purple-700 mb-4 w-full grid grid-cols-4">
              <TabsTrigger value="weapons" className="data-[state=active]:bg-purple-700 data-[state=active]:text-white">
                <Sword className="h-4 w-4 mr-2" />
                Weapons
              </TabsTrigger>
              <TabsTrigger value="armor" className="data-[state=active]:bg-purple-700 data-[state=active]:text-white">
              ...
              <TabsTrigger value="skins" className="data-[state=active]:bg-purple-700 data-[state=active]:text-white">
                ...
                {filteredItems.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                    {filteredItems.map((item) => (
                      <Card key={item.id} className="bg-purple-900/40 border-purple-700 overflow-hidden">
                        <div className="relative">
                          ...
                          />
                          <Badge className={`absolute top-2 right-2 ${rarityColors[item.rarity]}`}>{item.rarity}</Badge>
                        </div>
                        ...
                        <CardContent className="p-3 pt-2">
                          <div className="grid grid-cols-2 gap-2 text-xs mb-2">
                            {Object.entries(item.stats).map(([stat, value]) => (
                              ...
                              >
                                <span className="capitalize text-purple-300">{stat}:</span>
                          ...
                          <div className="flex items-center justify-between text-sm mt-2">
                            <div className="flex items-center gap-1 text-purple-300">
                              <span>Seller:</span>
                              <span className="font-medium text-white">{item.seller}</span>
                            </div>
                  ...
                  <div className="bg-purple-900/30 border border-purple-700 rounded-lg p-6 text-center">
                    ...
                    <p className="text-purple-300 text-sm">Try adjusting your search or filters</p>
                  </div>
                )}
              </TabsContent>
            ))}
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-purple-900/40 border-purple-700">
            <CardHeader className="pb-2">
              <CardTitle className="text-lg flex items-center justify-between">
                ...
                <Badge variant="outline" className="font-normal text-xs border-purple-500 text-purple-300">
                  {userInventory.length} Items
                </Badge>
              </CardTitle>
              <CardDescription className="text-purple-300">Items you can sell or trade</CardDescription>
            </CardHeader>
          ...
          <Card className="bg-purple-900/40 border-purple-700">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-purple-300">Latest marketplace activity</CardDescription>
            </CardHeader>
            <CardContent className="p-0">
              <ScrollArea className="h-[200px]">
                <div className="p-3 space-y-3">
                  {recentTransactions.map((tx) => (
                    <div key={tx.id} className="bg-purple-950/50 rounded-lg p-3 text-sm">
          ...
          <Card className="bg-purple-900/40 border-purple-700">
            <CardHeader className="pb-2">
              ...
              <CardDescription className="text-purple-300">Trading activity overview</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-purple-300">Total Volume (24h)</span>
                  <span className="font-bold">24,580 SUI</span>
                </div>
                <Separator className="bg-purple-700/50" />
                <div className="flex justify-between items-center">
                  <span className="text-sm text-purple-300">Active Listings</span>
                  <span className="font-bold">1,245</span>
                </div>
                <Separator className="bg-purple-700/50" />
                <div className="flex justify-between items-center">
                  <span className="text-sm text-purple-300">Avg. Item Price</span>
      ...
      <Dialog open={showBuyDialog} onOpenChange={setShowBuyDialog}>
        <DialogContent className="bg-purple-900 border-purple-700 text-white sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-purple-300">Confirm your purchase details</DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  />
                  <Badge className={`absolute -top-2 -right-2 ${rarityColors[selectedItem.rarity]}`}>
                    {selectedItem.rarity}
                  </Badge>
                </div>
                <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span>
                    {Math.round(selectedItem.price * 0.02)} {selectedItem.currency}
                  </span>
                </div>
                <Separator className="bg-purple-700" />
                <div className="flex justify-between items-center font-bold">
                  <span>Total</span>
                  <span>
                    {selectedItem.price + Math.round(selectedItem.price * 0.02)} {selectedItem.currency}
                  </span>
                </div>
              </div>
          ...
          <DialogFooter className="sm:justify-between">
            ...
            <Button onClick={completePurchase} className="bg-purple-600 hover:bg-purple-700">
              Confirm Purchase
            </Button>
          </DialogFooter>
        </DialogContent>
        ...
        <DialogContent className="bg-purple-900 border-purple-700 text-white sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-purple-300">
              {selectedInventoryItem ? "Set your price and details" : "Upload a new item to sell"}
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
            {selectedInventoryItem && (
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge className={`${rarityColors[selectedInventoryItem.rarity]}`}>
              ...
              <div className="space-y-3">
                <div className="grid w-full max-w-sm items-center gap-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSellItemDetails({ ...sellItemDetails, name: e.target.value })}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setSellItemDetails({ ...sellItemDetails, type: value })}
                    >
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => setSellItemDetails({ ...sellItemDetails, rarity: value })}
                    >
                      <SelectTrigger className="bg-purple-950/50 border-purple-700 focus:ring-purple-500">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="border-2 border-dashed border-purple-700 rounded-lg p-6 text-center hover:bg-purple-950/30 transition-colors cursor-pointer">
                    ...
                    <p className="text-sm text-purple-300">Click or drag to upload image</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSellItemDetails({ ...sellItemDetails, price: Number.parseInt(e.target.value) })}
                    className="bg-purple-950/50 border-purple-700 focus-visible:ring-purple-500"
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSellItemDetails({ ...sellItemDetails, currency: value })}
                  >
                    <SelectTrigger className="bg-purple-950/50 border-purple-700 focus:ring-purple-500">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  onChange={(e) => setSellItemDetails({ ...sellItemDetails, description: e.target.value })}
                  className="bg-purple-950/50 border-purple-700 focus-visible:ring-purple-500"
                />
              </div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="instant-sale">Allow instant sale at listed price</Label>
              </div>
            </div>
            ...
            <div className="bg-purple-950/70 rounded-lg p-3">
              <div className="flex justify-between items-center mb-2">
                ...
                <span>
                  {Math.round(sellItemDetails.price * 0.05)} {sellItemDetails.currency}
                </span>
              </div>
              <div className="flex justify-between items-center font-bold">
                <span>You'll Receive</span>
                <span>
                  {sellItemDetails.price - Math.round(sellItemDetails.price * 0.05)} {sellItemDetails.currency}
                </span>
              </div>
            </div>
          </div>
          ...
          <DialogFooter className="sm:justify-between">
            ...
            <Button onClick={completeSale} className="bg-purple-600 hover:bg-purple-700">
              List for Sale
            </Button>
          </DialogFooter>
        </DialogContent>
